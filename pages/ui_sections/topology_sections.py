    ...
    with col1:
        road_pole_spacing_m = st.slider(
            ...
            help=(
                ...
                "Smaller values â†’ more candidate poles (denser), potentially shorter userâ€“pole distances."
            ),
        )
    ...
    with col2:
        max_user_connection_radius_m = st.slider(
            ...
            help=(
                ...
                "Smaller values â†’ more unassociated buildings, which may require additional poles (or become standalone candidates)."
            ),
        )
